 ...
 * AI Prompt Templates
 * 
 * These templates are used by the PromptService to generate
 * consistent and effective prompts for the AI service.
 */
...
module.exports = {
   ...
   */
  questionGeneration: (resumeData, role, focusArea, difficulty, previousAnswers) => {
    const resumeContext = `
...
Respond in JSON format:
{
   ...
   */
  answerEvaluation: (question, answer, idealAnswer, evaluationCriteria) => {
...
Respond in JSON format:
{
   ...
   */
  followUpQuestion: (originalQuestion, originalAnswer, evaluation) => {
...
Respond in JSON format:
{
   ...
   */
  interviewSummary: (interviewData, allAnswers) => {
